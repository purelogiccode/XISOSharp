...
/// <param name="Count">Total count for <see cref="ProgressInfoType.FileCount"/> and <see cref="ProgressInfoType.DirCount"/>; total file bytes for <see cref="ProgressInfoType.FileProgress"/>; 0 otherwise.</param>
...
/// <param name="Size">Byte size written for <see cref="ProgressInfoType.FileAdded"/>; bytes copied so far for <see cref="ProgressInfoType.FileProgress"/>; 0 otherwise.</param>
