...
- [CLI Reference](cli.md) — every flag and mode
- [Library Overview](library.md) — architecture and API highlights
- [Redump & Disc Layouts](redump-workflows.md) — working with video partitions
