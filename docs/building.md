...
| `ZArchiveSharp` / `ZArchiveSharp.Tests` / `ZArchiveSharp.Benchmarks` | — | **Moved** to the sibling `../CSharp_ZArchiveSharp` repo (own solution); referenced here via a relative `ProjectReference` |
